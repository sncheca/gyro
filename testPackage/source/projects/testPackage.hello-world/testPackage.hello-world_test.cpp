...
#include "testPackage.hello-world.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<testPackage_hello-world> an_instance;
        testPackage_hello-world&              my_object = an_instance;
