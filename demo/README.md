The demo input file `mc-raw-paraisso.wav` can be downloaded from [here](https://yalmust.yale.edu/gyro). This is because it is too large to be hosted for free by `git-lfs` when many users download it. 
